...
<!-- Start Breadcrumb 
    ...
    <!-- Start Blog 
        ...
        <div class="blog-area full-blog bg-gray default-padding">
            <div class="container">
                <div class="row">
                    <a href="{{route('front.regulasi')}}" class="btn btn-primary"><i class="fas fa-angles-left"></i>Kembali</a>
                </div>
                <br>
                <div class="row">
                    <iframe src="https://portal-skpd.sumedangkab.go.id/{{$data->regulasi_file}}" width="100%" height="1200px"></iframe>
                </div>
            </div>
        </div>
        <!-- End Blog -->
